...
$('.pproptype').on('change', function(e){
    if(this.value == 'residential') {
        $('.psubprop').fadeIn();
    }
});
$('.cproptype').on('change', function(e){
    if(this.value == 'mudon') {
        $('.csubprop').fadeIn();
    }
});
$('.couproptype').on('change', function(e){
    if(this.value == 'uae') {
        $('.cousubprop').fadeIn();
    } else if(this.value == 'oman') {
        $('.cousubprop').fadeIn();
    } else if(this.value == 'qatar') {
        $('.cousubprop').fadeIn();
    } else if(this.value == 'ksa') {
        $('.cousubprop').fadeIn();
    } 
});
$('.cityproptype').on('change', function(e){
    if(this.value == 'city1') {
        $('.areasubprop').fadeIn();
    }else if(this.value == 'city2') {
        $('.areasubprop').fadeIn();
    } else if(this.value == 'city3') {
        $('.areasubprop').fadeIn();
    } else if(this.value == 'city4') {
        $('.areasubprop').fadeIn();
    } else if(this.value == 'city5') {
        $('.areasubprop').fadeIn();
    } 
});
$('.arearoptype').on('change', function(e){
    if(this.value == 'area1') {
        $('.areamap').fadeIn();
    }
});
